...
// by thorium://chrome-urls (about:about) and the built-in AutocompleteProvider.
...
// Add hosts here to be included in thorium://chrome-urls (about:about).
...
// Add thorium://internals/* subpages here to be included in thorium://chrome-urls
// (about:about).
